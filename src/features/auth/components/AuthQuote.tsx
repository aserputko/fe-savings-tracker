...
export function AuthQuote() {
  return (
    <div
      className='hidden lg:flex lg:flex-1 relative rounded-2xl flex-col items-start justify-center p-12 overflow-hidden border border-white/30 max-w-150'
    ...
    >
      <blockquote className='relative h-full flex-auto flex flex-col gap-4'>
        <div className='flex flex-col h-full items-center justify-center'>
          <p className='text-preset-1 text-neutral-0'>&ldquo;{randomQuote.text}&rdquo;</p>
        </div>
