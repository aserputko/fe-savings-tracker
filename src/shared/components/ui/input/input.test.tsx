...
describe('Input', () => {
  ...
  it('GIVEN required prop with label WHEN rendered THEN optional indicator is NOT shown', () => {
    render(<Input label='Amount' required />);
    expect(screen.queryByText('(optional)')).not.toBeInTheDocument();
    expect(screen.queryByText('*')).not.toBeInTheDocument();
  });

  it('GIVEN no required prop with label WHEN rendered THEN optional indicator is shown', () => {
    render(<Input label='Amount' />);
